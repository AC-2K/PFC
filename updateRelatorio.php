                        ...
                        <div class="page-wrapper">
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="card">
                                        <div class="card-body">
                                            <h5>Update relatorio tecnico</h5>
                                            <hr>
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <form>
                                                        <div class="form-group">
                                                            <label for="codigo">codigo relatorio</label>
                                                            <input type="text" class="form-control" id="codigo" aria-describedby="codigo" placeholder="Codigo do levantamento">
                                                        </div>
                                                        <div class="form-group">
