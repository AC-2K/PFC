<?php
   ...
   $conn = new mysqli($servername,$username,$password,$dbname);
    ...
    $sql2 = "select * from etapas_servico ";
                                                            ...
                                                            <table class="table table-hover">
                                                                ...
                                                                <tbody>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td> <?php echo $rows['t.nome']; ?> </td>
                                                                        <td> <?php echo $rows['dataInicio']; ?> </td>

                                                                        <td> <?php echo $rows['dataFim']; ?> </td>
                                                                        <td> <?php echo $rows['estimativaDias']; ?> </td>

                                                                        <td> <?php echo $rows['numeroEtapas']; ?> </td>
                                                                        <td> <?php echo $rows['pais']; ?> </td>

                                                                        <td> <?php echo $rows['provincia']; ?> </td>
                                                                        <td> <?php echo $rows['endereco']; ?> </td>

                                                                        <td> <?php echo $rows['estrutura']; ?> </td>
                                                                    </tr>
                                                                    <?php } ?>
                                                                </tbody>
                                                            </table>
                                                            ...
                                                            <table class="table table-hover">
                                                                ...
                                                                <tbody>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td> <?php echo $rows['actividadeDefinida']; ?> </td>
                                                                        <td> <?php echo $rows['dataInicio']; ?> </td>

                                                                        <td> <?php echo $rows['dataFim']; ?> </td>
                                                                        <td> <?php echo $rows['etapaAtual']; ?> </td>
                                                                    </tr>
                                                                    <?php } ?>
                                                                </tbody>
                                                            </table>
                                                        ...
                                                        <div class="table-responsive">
                                                            <table class="table table-hover">
                                                                ...
                                                                <tbody>
                                                                    ...
                                                                    ?>                                                                   
                                                                    <tr>
                                                                        <td> <?php echo $rows['cod_sistema']; ?> </td>
                                                                        <td> <?php echo $rows['servico_cod']; ?> </td>
                                                                        <td> <?php echo $rows['s.designacao']; ?> </td>
                                                                        <td> <?php echo $rows['c.nome']; ?> </td>
                                                                    </tr>
                                                                    <?php } ?>
                                                                </tbody>
