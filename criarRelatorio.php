                        ...
                        <div class="page-wrapper">
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="card">
                                        <div class="card-body">
                                            <h5>Emissão de relatorio técnico</h5>
                                            <hr>
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <form>
                                                        <div class="form-group">
                                                            <label for="codigoServico">codigo serviço</label>
                                                            <input type="text" class="form-control" id="codigoServico" aria-describedby="codigoServico" placeholder="Codigo do serviço">
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="etapa">Etapa serviço</label>
                                                            <input type="email" class="form-control" id="etapa" aria-describedby="etapa" placeholder=" ">
                                                        </div>
                                                        <div class="form-group">
