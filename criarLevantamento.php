            ...
            <div class="pcoded-content">
                <div class="pcoded-inner-content">
                    <div class="main-body">
                        <div class="page-wrapper">
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="card">
                                        <div class="card-body">
                                            <h5>Emitir Levantamento</h5>
                                            <hr>
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <form method="Post" action="metodoCriar.php">
                                                        <div class="form-group">
                                                            <label for="nome">Código de serviço técnico Activo</label>
                                                            <input type="number" class="form-control" name="codigoTecnico"  id="codigoTecnico" aria-describedby="codigoTecnico"  value="0" placeholder="Codigo">
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="area">Descricao geral</label>
                                                            <textarea class="form-control "name="observacao"  id="area" rows="20"></textarea>
                                                        </div>
                                                        <input type="hidden" name="criar" value="4">
                        ...
                        <div> Lista de servicos técnicos em percurso</div>
                        </div>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-hover">
                                            ...
                                            <tbody>
                                                ...
                                                ?>                                                                   
                                                <tr>
                                                    <td> <?php echo $rows['cod_servico']; ?> </td>
                                                    <td> <?php echo $rows['c.nome']; ?> </td>
                                                    <td> <?php echo $rows['descricao_geral']; ?> </td>
                                                </tr>
                                                <?php } ?>
                                            </tbody>
                                        </table>
