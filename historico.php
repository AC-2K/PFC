                                ...
                                <div class="col-sm-12">
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <hr>
                                            <button type="submit" class="btn btn-primary" id="historicoACT" >Actualizar</button>
                                            <button type="submit" class="btn btn-danger" id="historicoDel" >Apagar</button>
                                            <hr>

                                            <!-- ------------------------------------------------------------------------ -->
                                            <!-- Modal 2  - Actualizar Material -->
                                            <div class="modal fade" id="myModalActHistorico" role="dialog">
                                                        ...
                                                        <form action="metodoUpdate.php" method="POST" enctype="multipart/form-data" >
                                                            <div class="modal-body">
                                                                <div class="form-group">
                                                                    <label for="selectServico">Serviço técnico </label> 
                                                            ...
                                                            <div class="modal-footer">
                                                                ...
                                                                <button class="btn btn-primary" name="submeter" value="historico" id="actualizarHistorico">continuar</button>
                                                            </div>
                                                        </form>
                                                    </div>
                                                </div>
