                ...
                <ul class="nav pcoded-inner-navbar">
                    ...
                    <li data-username="basic components Button Alert Badges breadcrumb Paggination progress Tooltip popovers Carousel Cards Collapse Tabs pills Modal Grid System Typography Extra Shadows Embeds" class="nav-item pcoded-hasmenu">
                        ...
                        <ul class="pcoded-submenu">
                            <li class=""><a href="bc_badges.html" class="">Visualizar</a></li>
                        </ul>
                    </li>
                    <li data-username="basic components Button Alert Badges breadcrumb Paggination progress Tooltip popovers Carousel Cards Collapse Tabs pills Modal Grid System Typography Extra Shadows Embeds" class="nav-item pcoded-hasmenu">
                        ...
                        <ul class="pcoded-submenu">
                            <li class=""><a href="bc_button.html" class="">Criar</a></li>
                            <li class=""><a href="bc_badges.html" class="">Visualizar</a></li>
                            <li class=""><a href="bc_breadcrumb-pagination.html" class="">Update</a></li>
                            <li class=""><a href="bc_collapse.html" class="">Apagar</a></li>
                        </ul>
                    </li>
                    <li data-username="basic components Button Alert Badges breadcrumb Paggination progress Tooltip popovers Carousel Cards Collapse Tabs pills Modal Grid System Typography Extra Shadows Embeds" class="nav-item pcoded-hasmenu">
                    ...
                    <li data-username="basic components Button Alert Badges breadcrumb Paggination progress Tooltip popovers Carousel Cards Collapse Tabs pills Modal Grid System Typography Extra Shadows Embeds" class="nav-item pcoded-hasmenu">
                        ...
                        <ul class="pcoded-submenu">
                            <li class=""><a href="bc_button.html" class="">Emissao</a></li>
                            <li class=""><a href="bc_badges.html" class="">Visualizar</a></li>
                            <li class=""><a href="bc_breadcrumb-pagination.html" class="">Update</a></li>
                            <li class=""><a href="bc_collapse.html" class="">Apagar</a></li>
                        </ul>
                        ...
                        <div class="page-wrapper">
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="card">
                                        <div class="card-body">
                                            <h5>Update servico tecnico</h5>
                                            <hr>
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <form>
                                                        <div class="form-group">
                                                            <label for="codigo">Codigo ID</label>
                                                            <input type="number" class="form-control" id="codigo" aria-describedby="codigo" placeholder="codigo">
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="descricao">Descricao Geral</label>
                                                            <textarea class="form-control" id="descricao" rows="20"></textarea>
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="estimativa">Estimativa de duração em dias</label>
                                                            <input type="number" class="form-control" id="estimativa" aria-describedby="estimativa" placeholder="Estimativa">
                                                        </div>
                                                        <div class="form-group">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <select class="form-control" id="aprovado">
                                                                <option>sim</option>
                                                                <option>nao</option>
                                                            </select>
                                                        </div>
                                                        <div class="form-group">
                                                            ...
                                                            <input type="date" class="form-control" id="dataInicio" aria-describedby="dataInicio" placeholder="dataInicio">
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="dataFim">Data de terminio</label>
                                                            <input type="date" class="form-control" id="dataFim" aria-describedby="dataFim" placeholder="dataFim">
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="anexo">Anexo</label>
                                                            <input type="file" class="form-control" id="anexo" aria-describedby="anexo" placeholder="anexo">
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="etapa">Numeros de etapas</label>
                                                            <input type="number" class="form-control" id="etapa" aria-describedby="etapa" placeholder="etapa">
                                                        </div>
                                                ...
                                                <div class="col-md-6">
                                                    <form>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control" id="provincia" aria-describedby="provincia" placeholder="provincia">
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="endereco">Endereço</label>
                                                            <input type="text" class="form-control" id="endereco" aria-describedby="endereco" placeholder="endereco">
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="estrutura">Tipo de estrutura</label>
                                                            <input type="text" class="form-control" id="estrutura" aria-describedby="estrutura" placeholder="estrutura">
                                                        </div>
                                                        <button type="submit" class="btn btn-primary">Atualizar</button>
                                                    </form>
                                                </div>
