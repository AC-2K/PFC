                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <form>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input type="email" class="form-control" id="mail" aria-describedby="mail" placeholder="Endereço email">
                                                        </div>
                                                        <div class="form-group">
                                                ...
                                                <div class="col-md-6">
                                                    <form>
                                                        <div class="form-group">
                                                            <label for="responsavel" >Nome do responsavel - Se for necessario</label>
                                                            <input type="text" class="form-control" id="responsavel" placeholder="responsavel">
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="telefone" >Numero telefone</label>
                                                            <input type="text" class="form-control" id="telefone" placeholder="Numero telefone">
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="code">Codigo cliente</label>
                                                            <input type="text" class="form-control" id="code" placeholder="Codigo cliente">
                                                        </div>
                                                        <button type="submit" class="btn btn-primary">Inserir numero</button>
                                                    </form>
                                                </div>
                                            </div>
                                        </div>
