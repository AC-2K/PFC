                                                            ...
                                                            <table class="table table-hover">
                                                                ...
                                                                <tbody>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td> <?php echo $rows['cliente_email']; ?> </td>
                                                                        <td> <?php echo $rows['cliente_numServico']; ?> </td>
                                                                        <td> <?php echo $rows['cliente_sexo']; ?> </td>
                                                                        <td> <?php echo $rows['cliente_tipo']; ?> </td>
                                                                        <td> <?php echo $rows['cliente_responsavel']; ?> </td>
                                                                    </tr>
                                                                    <?php } ?>
                                                                </tbody>
                                                            </table>
